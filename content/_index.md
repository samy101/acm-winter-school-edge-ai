      ...
      text: |
        ...
        <div style="width: 20%; min-width: 100px; margin: 40px 10px;">
          <a href="https://people.cs.umass.edu/~shenoy/">
            <img src="speaker_prashant.jpg" alt="Photo of Prashant Shenoy" style="width: 100%; height: auto; border-radius: 50%; aspect-ratio: 1/1; object-fit: cover; object-position: top; border: 3px solid #90A2AF;">
          </a>
          <p><a href="https://people.cs.umass.edu/~shenoy/"><strong>Prashant Shenoy</strong></a><br/>University of Massachusetts</p>
        </div>
  ...
  - block: features
    ...
    content:
      ...
      text: |
        ...
        <tr style="background-color:#F7E8FF;"><td style="padding:8px;">6:00 – 7:00 PM</td><td style="padding:8px;">Prashant Shenoy (University of Massachusetts)<sup>†</sup></td><td style="padding:8px;">Data Centers, AI Workloads, and Efficiency: An Edge Systems Perspective</td></tr>
        </tbody></table>
        <br><br>   
        ...
        <tr style="background-color:#F5F7F8;"><td style="padding:8px;">11:00 – 11:15 AM</td><td colspan="2" style="padding:8px; text-align:center;">Tea/Coffee/Snacks</td></tr>
        <tr style="background-color:#FFF3E8;"><td style="padding:8px;">11:15 – 12:45 PM</td><td style="padding:8px;">Prasant Misra (IISc & TCS)</td><td style="padding:8px;">Edge AI in Mobility</td></tr>
        <tr style="background-color:#F5F7F8;"><td style="padding:8px;">12:45 – 2:00 PM</td><td colspan="2" style="padding:8px; text-align:center;">Lunch</td></tr>
        ...
        <thead><tr style="background-color:#ddd;"><th style="padding:8px;">Time</th><th style="padding:8px;">Speaker</th><th style="padding:8px;">Title</th></tr></thead>
        <tbody>
        <tr style="background-color:#F7E8FF;"><td style="padding:8px;">9:00 – 10:00 AM</td><td style="padding:8px;">Sajal Das (Missouri University of Science and Technology, USA)<sup>†</sup></td><td style="padding:8px;">Smart Connected Farms: AI and IoT-based Pest Management in Precision Agriculture</td></tr>
  ...
  - block: markdown
    ...
    content:
      ...
      text: |
        ...
        * **Address:** Opposite NMR Research Centre (Next to CCE Building), Student Council Road, IISc Campus, Devasandra Layout Bengaluru, Karnataka 560012.
        * **Reception Number:** 08022932535
