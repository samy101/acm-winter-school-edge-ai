  ...
  - block: features
    ...
    content:
      ...
      text: |
        ...
        <tr style="background-color:#F7E8FF;"><td style="padding:8px;">6:00 – 7:00 PM</td><td style="padding:8px;">Prashant Shenoy (UMass)</td><td style="padding:8px;">Keynote Talk</td></tr>
        </tbody></table>
        <br><br>   
