  ...
  - block: features
    ...
    content:
      ...
      text: |
        ...
        <thead><tr style="background-color:#ddd;"><th style="padding:8px;">Time</th><th style="padding:8px;">Speaker</th><th style="padding:8px;">Title</th></tr></thead>
        <tbody>
        <tr style="background-color:#F7E8FF;"><td style="padding:8px;">9:00 – 10:00 AM</td><td style="padding:8px;">Archan Misra (SMU)<sup>†</sup></td><td style="padding:8px;">Edge AI for Urban Systems</td></tr>
